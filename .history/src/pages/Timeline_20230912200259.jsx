        ...
        <div className=" mx-auto w-full h-full" id="timeline">
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
                <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border left-1/2" ></div>     
                    <RightTimeline timelineimage={Notification} timelinetitle={"Member"} timelinedesc={"Acquire merchandise ahead of the crowd and discounted prices on all of our events. If you are willing to, you can also help us setup our events :P."}/>
                    <LeftTimeline timelineimage={Interview} timelinetitle={"Subco"} timelinedesc={"Join our interview and be selected to be one of us. Work together with our Exco's and bring our events to life."}/>
