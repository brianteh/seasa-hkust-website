        ...
        <div className=" mx-auto w-full h-full" id="timeline">
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
                <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border left-1/2" ></div>     
                    ...
                    <RightTimeline timelineimage={Selection} timelinetitle={"Interview"} timelinedesc={"Show us your character through an interview with our Executive Committee members!"}/>
