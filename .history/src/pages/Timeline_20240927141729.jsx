        ...
        <div className=" mx-auto w-full h-full" id="timeline">
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
                <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border left-1/2" ></div>     
                    <RightTimeline timelineimage={Notification} timelinetitle={"Member"} timelinedesc={"Acquire merchandise ahead of the crowd, discounted prices on all of our events and a digital membership card!"} timelinetitle={"Member"} timelinedesc={"Acquire merchandise ahead of the crowd, discounted prices on all of our events and a digital membership card!"}/>
