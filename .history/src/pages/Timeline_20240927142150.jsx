        ...
        <div className=" mx-auto w-full h-full" id="timeline">
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
                <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border left-1/2" ></div>     
                    <RightTimeline timelineimage={Notification} timelinetitle={"Subco Recruitment Opens"} timelinedesc={""} />
                    
                    <LeftTimeline timelineimage={Interview} timelinetitle={"Subcommittee - Open Recruitment"} timelinedesc={"Register to become a part of SEASA's inner team!"}/>
