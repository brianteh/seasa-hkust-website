    ...
    <>
        <div className=" mx-auto w-full h-full" id="timeline">
            <div className='text-center'>
                ...
                <span className="block mb-2 text-lg font-semibold text-primary pt-0.5">
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
                <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border left-1/2" ></div>     
                    ...
                    <LeftTimeline timelinedate= {"29 Sep"} timelineimage={Interview} timelinetitle={"Subcommittee - Closed Recruitment"} timelinedesc={"Deadline to apply for our Subcommitte division."}/>
                    <RightTimeline timelinedate= {" Sep"} timelineimage={Selection} timelinetitle={"Initial Screening Results"} timelinedesc={"Interview applicants are announced."}/>
                    <LeftTimeline timelinedate= {"1-14 Oct"} timelineimage={Selection} timelinetitle={"Interview"} timelinedesc={"Show us your character through an interview with our Executive Committee members!"}/>
