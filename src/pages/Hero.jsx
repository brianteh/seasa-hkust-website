...
const Hero = () => {
  ...
  return (
    <>
        {/* First section with text content - keep as is */}
        ...
        {/* Keep modal component */}
        <Modal onClose={handleClose} visible={myModal}/>

        {/* Full-width container for the image section */}
        <div className="relative w-full py-16">
          {/* Shapes container that spans full width */}
          <div className="relative w-full max-w-screen-2xl mx-auto">
            {/* Left shape positioned to the left edge */}
            ...
            {/* Right shape positioned to the right edge */}
            ...
            {/* Main image container centered between shapes */}
        ...
        {/* Responsive spacer - adjust as needed */}
