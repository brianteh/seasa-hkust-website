...
const LeftTimeline = ({ timelinestep, timelineimage, timelinetitle, timelinedesc, timelinestatus, statusClass, icon, isoDate, spineMode }) => {
  const computedMode = computeSpineMode({ status: timelinestatus, spineMode });
  
  return (
    <div className="mb-16 md:mb-20 flex justify-between flex-row-reverse items-center w-full left-timeline" role="listitem">
